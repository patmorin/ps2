\documentclass[a4paper,UKenglish,autoref]{lipics-v2021}
...
\title{An Optimal Algorithm for Product Structure \newline in Planar Graphs}

\titlerunning{An Optimal Algorithm for Product Structure}
...
\authorrunning{P. Bose, P. Morin, and S. Odak}
\Copyright{Prosenjit Bose, Pat Morin, and Saeed Odak}

\keywords{Planar graphs, product structure}
...
% \author{Prosenjit Bose}{Carleton University, School of Computer Science} %{jit@scs.carleton.ca}{dorcidid}
% \author{Pat Morin}{Carleton University, School of Computer Science}% {morin@scs.carleton.ca}{dorcidid}
% \author{Saeed Odak}{University of Ottawa, Department of Computer Science and Electrical Engineering}%{saeedodak@gmail.com}{dorcidid}
% \author{%
...
\begin{figure}
  \begin{center}
    \begin{tabular}{ccc}
      \includegraphics[scale=0.75]{figs/model-1} &
      &
      \includegraphics[scale=0.75]{figs/model-2} \\
    \end{tabular}
  \end{center}
...
\begin{figure}
  \begin{center}
    \begin{tabular}{cc}
      \includegraphics{figs/tripod-decomp-1} &
      \includegraphics{figs/tripod-decomp-2}
    \end{tabular}
  \end{center}
